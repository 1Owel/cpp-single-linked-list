...
public:
    ...
    Iterator EraseAfter(ConstIterator pos) noexcept {
        Node* for_del = pos.node_->next_node;
        pos.node_->next_node = for_del->next_node;
        delete for_del;
        --size_;
        ++pos;
        Iterator iter = begin();
    ...
    SingleLinkedList(const SingleLinkedList& other) {
        ...
        {
            Node* tmp_node_ = &tmp.head_;
            auto iter = other.begin();
            while (iter != other.end()) {
                tmp_node_->next_node = new Node(*iter, nullptr);
                tmp_node_ = tmp_node_->next_node;
                ++tmp.size_;
                ++iter;
            }
        }
    ...
    void swap(SingleLinkedList& other) noexcept {
        if (this != &other)
        {
            ...
            Node* tmp_node = this->head_.next_node;
